...
var colorOptions = [{ en: 'black', ua: 'Чорний' }, { en: 'white', ua: 'Білий' }, { en: 'silver', ua: 'Сірий' }];

var sizeOptions = ["S", "M", "L", "XL", "XXL", "XXXL"];
...
var priceFilter = function priceFilter(_ref) {
    ...
    return React.createElement(
        ...
        React.createElement("input", { name: "filter_price", className: "hidden-checkbox-input", value: rangeValues }),
    ...
    return React.createElement(
        ...
        colorOptions.map(function (el, i) {
            return React.createElement(
                ...
                React.createElement("span", { className: "checkbox-mask checkbox-mask-" + el.en })
            );
        })
    );
};
...
var filterComponents = [{ title: 'Ціна', name: priceFilter }, { title: 'Колір', name: ColorFilter }, { title: 'Розмір', name: SizesFilter }];
                ...
                filterComponents.map(function (el, i) {
                    ...
                    return React.createElement(
                        ...
                        React.createElement(
                            ...
                            React.createElement(Component, { handleFiltersFields: handleFiltersFields })
                        )
                    );
                })
            )
